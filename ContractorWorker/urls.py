...
urlpatterns = [
   ...
   ######## User Module ########
     ...
     re_path(r'^User_MyProfileUpdate$', views.User_MyProfileUpdate, name='User_MyProfileUpdate'),
     re_path(r'^User_MyProfileUpdatessave/(?P<id>\d+)/$', views.User_MyProfileUpdatessave, name='User_MyProfileUpdatessave'),
     ...
     re_path(r'^Worker_UpdateWorkDetailssave$', views.Worker_UpdateWorkDetailssave, name='Worker_UpdateWorkDetailssave'),
