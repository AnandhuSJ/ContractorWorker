...
urlpatterns = [
   ...
   ######## User Module ########
     ...
     re_path(r'^usr_feedback/(?P<id>\d+)/$', views.usr_feedback, name='usr_feedback'),
     ...
     re_path(r'^Worker_UpdateWorkDetails/(?P<id>\d+)/$', views.Worker_UpdateWorkDetails, name='Worker_UpdateWorkDetails'),
     re_path(r'^Worker_UpdateWorkDetailssave/(?P<id>\d+)/$', views.Worker_UpdateWorkDetailssave, name='Worker_UpdateWorkDetailssave'),
     ...
     re_path(r'^Worker_Accsetting/(?P<id>\d+)/$',views.Worker_Accsetting,name='Worker_Accsetting'),
     ...
     re_path(r'^con_feedback/(?P<id>\d+)/$', views.con_feedback, name='con_feedback'),
     re_path(r'^Contractor_UpdateWorkDetails/(?P<id>\d+)/$', views.Contractor_UpdateWorkDetails, name='Contractor_UpdateWorkDetails'),
     re_path(r'^Contractor_UpdateWorkDetailssave/(?P<id>\d+)/$', views.Contractor_UpdateWorkDetailssave, name='Contractor_UpdateWorkDetailssave'),
